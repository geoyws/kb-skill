# /kb reference — the long-form half

This is the reference half of the `kb` skill. `SKILL.md` is the daily
surface every session reads before touching the board: the board-home
boundary, aliases, addressing a board, claims and leases, handoffs,
attention, sitreps, tags, `transact` in brief, and the refusals worth
knowing. Everything else lives here, verbatim, under the same `##`
headings — the long form of a section `SKILL.md` shows in short, plus the
sections `SKILL.md` does not carry at all. Nothing here is optional once
the daily surface points you at it.

## Board home host is the execution boundary

Daily form: `SKILL.md`, section "Board home host is the execution boundary".
...
Daily form: `SKILL.md`, section "Aliases".
...
Daily form: `SKILL.md`, section "Addressing a board".
...
Daily form: `SKILL.md`, section "Attention — anything that needs the owner".
...
Daily form: `SKILL.md`, section "Sitreps — where a lane stands, cheaply".
...
Daily form: `SKILL.md`, section "Handoffs — task and session".
...
Daily form: `SKILL.md`, section "Working a task".
...
Daily form: `SKILL.md`, section "Batched writes — `transact`".
...
Daily form: `SKILL.md`, section "Tags — which part of the system this is about".
...
Daily form: `SKILL.md`, section "Refusals worth knowing".
